        ...
        <div class="wrapper">
            ...
            <div class="col-12 box">
                    <div class="col-10 box1">
                        ...
                        <center><img src="../home/images/profile.jpg"></center>
                        <center><h1><?php echo "Name : ".$_SESSION['fullname'] ?></h1></center>
                        <center><h1><?php echo "E-mail : ".$_SESSION['email'] ?></h1></center>
                        <center><h1><?php echo "Phone : ".$_SESSION['pno'] ?></h1></center>
                    </div>
                </div>
